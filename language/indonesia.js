...
exports.ok = () => {
    return `✅ Done. Jangan Lupa Berterima Kasih🙏🤓`
}
...
*⌚Time Server : ${time}*
*📚 List-Menu Obotz - Md :*
                                           محمد فتوحال عارفين أنا, بسم الله الرحمن الرحيم
╭─❒ 「 Bot Information 」 
├ ${prefix}owner
├ ${prefix}rules
├ ${prefix}sc
...
exports.welcome = () =>{
	return`Semoga Betah Ya Kak🤓
}
exports.leave = () =>{
	return`..........Selamat Jalan && Selamat Tinggal
